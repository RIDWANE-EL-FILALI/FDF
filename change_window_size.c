...
{
    if ((key == 0 && matrix[0][0].win_y <= 500) || (key == 6 && matrix[0][0].win_x <= 500))
        return (1);
    if ((key == 1 && matrix[0][0].win_y > 1000) || (key == 7 && matrix[0][0].win_x > 2000))
        return (1);
    return (0);
}
...
void new_window(int key, t_dot **matrix)
{
    ...
    matrix[0][0].win_ptr = mlx_new_window(matrix[0][0].mlx_ptr, matrix[0][0].win_x, matrix[0][0].win_x, "FDF");
